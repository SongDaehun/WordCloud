...
const databaseURL = "https://wordcloud-87a91-default-rtdb.firebaseio.com/";
		...
		return (
			<>
				...
				<Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
					...
					<DialogContent>
						<TextField label="텍스트 이름" type="text" name="textName" value={this.state.textName} onChange={this.handleValueChange}></TextField> < br /> < br />
